...
public class FarmerServiceImpl implements FarmerService {
  ...
  public FarmerServiceImpl(
      FarmerRepository farmerRepository, PasswordEncoder encoder, JavaMailSender mailSender) {
  ...
  public void sendFindPswEmail(Farmer farmer) {
    ...
    try {
      emailService.sendFarmerMail(
          email, "Bake Your Life 烘焙材料網 重設您的密碼", farmer, "farmerfindpswmail");
  ...
  // --------------------------------------------------------------------------------
  @Override
  public void register(Farmer farmer) throws UnsupportedEncodingException, MessagingException {
  ...
  public void sendVerificationEmail(Farmer farmer)
    ...
    try {
      emailService.sendFarmerMail(
          email, "Bake Your Life 烘焙材料網 小農廠商註冊驗證信件", farmer, "farmersignupmail");
    } catch (MessagingException e) {
      throw new RuntimeException(e);
    }
  }
