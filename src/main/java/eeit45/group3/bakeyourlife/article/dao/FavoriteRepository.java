...
@Query(nativeQuery = true, value = "SELECT * FROM favorite WHERE use_id = :user_id AND article_id = :post_id") // ?1 or $1
Boolean findFavoriteByUserAndPostID(@Param("user_id") User user_id, @Param("post_id") Integer post_id);
}
