...
public class FrontArticleController {
  ...
  public String processInsert(
      @Valid @ModelAttribute("articles") Article articleInfo,
  ...
  //    private String processSelect(@Valid @ModelAttribute("SelectArticle") Article
  // articles,@RequestParam(required = false) String title,@RequestParam(required = false) Date
  // date,
