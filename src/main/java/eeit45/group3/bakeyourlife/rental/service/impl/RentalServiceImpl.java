...
public class RentalServiceImpl implements RentalService {
  ...
  public List<Rental> findAllByUserAndTypeAndRentalNoStartingWith(
      Integer userId, String listType, String rentalNo) {
    User userBean = userService.findByUserId(userId);
    return rentalRepository.findAllByUserAndTypeAndRentalNoStartingWith(
        userBean, listType, rentalNo);
  }
  ...
  public Rental updateRental(Rental rental) {
    ...
    if ("已付款".equals(rental.getState())) {
      ...
      try {
        emailService.sendRentalMail(
            email, "[Bake Your Life 烘焙材料網] 租借單已付款成功通知", rental, "rentalfinish");
  ...
  @Override
  @Transactional
  public VenueList createVenueList(VenueListRequest venueListRequest, Principal principal)
  ...
  public VenueList updateVenueList3(Rental rental, VenueListRequest venueListRequest) {
    ...
    VenueList venueList =
        venueListRepository.findByRentalAndVenueAndRentalDateAndPeriod(
            rental, venue, venueListRequest.getRentalDate(), venueListRequest.getPeriod());
  ...
  public VenueList findByRentalAndVenueAndRentalDateAndPeriod(
      Rental rental, Venue venue, Date date, String state) {
    return venueListRepository.findByRentalAndVenueAndRentalDateAndPeriod(
        rental, venue, date, state);
  }
  ...
  @Override
  public void sendRentalMail(Rental rental)
