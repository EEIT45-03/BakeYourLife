...
public class AdminRentalController {
  ...
  public String viewIndex(
    ...
    if (select.size() == 1) {
      ...
      rentals =
          rentalService.findAllByUserAndTypeAndRentalNoStartingWith(
              Integer.valueOf(user1), listType, rNo);
    } else {
  ...
  public String updateRental(
      @RequestParam Integer rentalId, @ModelAttribute("rentalRequest") Rental rental) {
  ...
  public String createTackleList(
      @RequestParam Integer FK_rentalId,
      @ModelAttribute("tackleList") TackleListRequest tackleList) {
  ...
  public String updateTackleList(
      @RequestParam Integer tackleListId, @ModelAttribute("rentalRequest") TackleList tackleList) {
  ...
  public String createVenueList(
      @RequestParam Integer FK_rentalId, @ModelAttribute("venueList") VenueList venueList) {
  ...
  public String updateVenueList(
      @RequestParam Integer venueListId, @ModelAttribute("venueListRequest") VenueList venueList) {
