...
public class RentalController {
  ...
  public String viewVenueCommodity(@PathVariable Integer id, Model model) {
  ...
  public String viewTackleCommodity(@PathVariable Integer id, Model model) {
  ...
  public String viewUserRentalUpdate(@PathVariable Integer id, Model m) {
