...
public class OrderUIController {
  ...
  @Autowired private FarmerProductService farmerProductService;
  ...
  public String viewCheckOut(
      @ModelAttribute("cart") Cart cart, Model model, Authentication authentication) {
              ...
              switch (review.getProductNo().charAt(0)) {
                case 'F':
                  ...
                  FarmerProductBean farmerProductBean =
                      farmerProductService.findByFarmerProductId(id);
                  if (user != null && farmerProductBean != null) {
                    Date date = new Date();
                    productComment =
                        new ProductComment(farmerProductBean, user, date, comment, star);
