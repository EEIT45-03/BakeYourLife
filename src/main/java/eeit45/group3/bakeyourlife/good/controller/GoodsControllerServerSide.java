...
public class GoodsControllerServerSide {
  ...
  public boolean CheckGoods(
      @RequestParam("name") String name, @RequestParam(required = false) Integer id) {
  ...
  public String viewUpdateUser2(
      @RequestParam("id") int id, Model model, @ModelAttribute("Goods") Goods good) {
    good.setId(id);
