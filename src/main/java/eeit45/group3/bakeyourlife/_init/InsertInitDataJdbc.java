...
public class InsertInitDataJdbc {
    ...
    public void saveAllByOrders(List<Order> orders) {
        String orderSql = "insert into orders (order_id,address, code, discount_amount, is_review," +
                ...
                "values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        String orderItemSql = " insert into order_item (item_no,order_id, product_name, product_no, product_type, qty, sub_total)" +
                " values (?, ?, ?, ?, ?, ?, ?)";
