...
public class FarmerProductSupplierController {
  ...
  @Autowired
  public FarmerProductSupplierController(
  ...
  public String updateSupplier(
      ...
      @RequestParam(required = false) Farmer password,
      Farmer farmer) {
  ...
  public String viewProductList(Model model, Principal principal) {
    ...
    if (principal != null) {
      ...
      List<FarmerProductBean> farmerProductBeans =
          farmerProductService.findByFarmerFarmerIdOrderByLaunchedTimeDesc(farmer.getFarmerId());
