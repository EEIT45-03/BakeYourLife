...
public class ChatBotController {
  ...
  public Object webhook(@RequestBody String bodyStr) throws JsonProcessingException {
    ...
    /** Info 訊息 */
    dialogflowMessenger.addInfoMessage(
        "Info標題",
        "內文",
        "https://i.imgur.com/N42uCxU.jpg",
        "http://localhost:8080/FrontArticle/ArticleDetail?postid=1");
    ...
    /** Icon Type : https://fonts.google.com/icons?selected=Material+Icons Button 訊息 */
    dialogflowMessenger.addButtonMessage(
        "Home", "#FF9800", "Button文字", "http://localhost:8080/", null, null, null);

    /** Accordion 訊息 伸縮訊息 */
    dialogflowMessenger.addAccordionMessage(
        "Accordion標題", "內文", "https://i.imgur.com/N42uCxU.jpg", "藏起來的文字");
