...
public class StudentResult {
    ...
    public StudentResult(Integer strId, Product product, User user, Date time, String strTitle, String strContent, String resultImageUrl, MultipartFile resultFile) {
        this.strId = strId;
