...
public class CourseServiceImpl implements CourseService {
  ...
  // UserService userService, VenueService venueService, EmailService emailService,
  // CourseTimeRepository courseTimeRepository, RegisterRepository registerRepository) {
  ...
  @Override
  @Transactional
  public void deleteByCtId(Integer ctimeId) {
    courseTimeRepository.deleteById(ctimeId);
  }
  ...
  @Override
  @Transactional
  public void createCourseTime(CourseTime courseTime) {
    courseTimeRepository.save(courseTime);
  }
  ...
  public void updateRegister(
      Integer registerId, Integer attendance, Integer state, Integer totalPrice) {
  ...
  public void createRegisterWithId(Register register) {
    ...
    try {
      emailService.sendRegisterMail(
          email, "[Bake Your Life 烘焙材料網] 報名成功通知", register, "courseRegister");
