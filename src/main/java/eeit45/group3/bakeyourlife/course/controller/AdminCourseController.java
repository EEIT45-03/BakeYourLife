...
public class AdminCourseController {
  ...
  public String createCreateCtime(
      @RequestParam(value = "FK_courseId") Integer FK_opCourseId,
      @ModelAttribute("courseTime") CourseTime courseTime) {
